...
function resetForm() { $("payment-form").reset(); $("payment-id").value = ""; $("form-title").textContent = "Add payment"; $("save-button").textContent = "Add"; $("cancel-edit-button").classList.add("hidden"); message(formMessage); }
